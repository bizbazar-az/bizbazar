...
const STRINGS = {
  az: {
    ...
    form_photos_hint: "JPG və ya PNG, hər biri maksimum 5 MB",
    form_photos_btn: "📷 Şəkil əlavə et",
    form_photos_max: "Maksimum 5 şəkil əlavə edə bilərsiniz.",
    form_photos_size: "Bu şəkil 5 MB-dan böyükdür:",
  ...
  en: {
    ...
    form_photos_hint: "JPG or PNG, max 5 MB each",
    form_photos_btn: "📷 Add photos",
    form_photos_max: "You can add a maximum of 5 photos.",
    form_photos_size: "This photo exceeds 5 MB:",
  ...
  ru: {
    ...
    form_photos_hint: "JPG или PNG, каждое не более 5 МБ",
    form_photos_btn: "📷 Добавить фото",
    form_photos_max: "Можно добавить максимум 5 фотографий.",
    form_photos_size: "Это фото больше 5 МБ:",
